    ...
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            ApplicationUser admin = new ApplicationUser()
            {
                ...
                EmailConfirmed = true,
                PhoneNumber = "+55 (11) 2345-6780",
                FirstName = "Richard",
                LastName = "Admin"
            };

            _user.CreateAsync(admin, "Pass123!").GetAwaiter().GetResult();
            ...
            ApplicationUser client = new ApplicationUser()
            {
                ...
                Email = "richard-client@email.com",
                EmailConfirmed = true,
                PhoneNumber = "+55 (11) 2345-6780",
                FirstName = "Richard",
                LastName = "Client"
            ...
            _user.CreateAsync(client, "Pass123!").GetAwaiter().GetResult();
